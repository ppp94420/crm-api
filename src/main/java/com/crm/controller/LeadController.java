...
public class LeadController {
    ...
    @Log(title = "线索列表-分页参数",businessType = BusinessType.SELECT)
    ...
    @Log(title = "线索列表-保存或修改",businessType = BusinessType.SELECT)
    ...
    @Log(title = "线索列表-跟进线索",businessType = BusinessType.SELECT)
    public Result followed(@RequestBody @Validated FollowUp followUp) {
    ...
    @Log(title = "线索列表-线索转客户",businessType = BusinessType.SELECT)
