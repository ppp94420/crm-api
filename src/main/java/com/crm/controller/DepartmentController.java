...
public class DepartmentController {
    ...
    @Log(title = "部门列表-查询参数",businessType = BusinessType.SELECT)
    ...
    @Log(title = "部门列表-保存或编辑",businessType = BusinessType.SELECT)
    ...
    @Log(title = "部门列表-删除参数",businessType = BusinessType.SELECT)
